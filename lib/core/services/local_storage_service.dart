...
class LocalStorageService {
  ...
  static Future<void> init() async {
    ...
    // // Generate encryption key (store securely in real apps!)
    final key = encrypt.Key.fromLength(32); // TODO: Store in secure storage
    final encryptionKey = Uint8List.fromList(key.bytes);
